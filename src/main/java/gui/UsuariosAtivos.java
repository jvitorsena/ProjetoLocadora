 ...
 * @author jvito
 */
public class UsuariosAtivos extends javax.swing.JFrame {
    ...
    private void carregaTabela(){
        ...
        ArrayList<Usuario> usuarios = usuariodb.listarUsuariosAtivos();
    ...
    private void btnDesativarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDesativarActionPerformed
        ...
        if ("".equals(this.txtIdUsuario.getText())){
            ...
            u = udb.listarUsuariosAtivos().get(index);
            
            txtIdUsuario.setText(String.valueOf(u.getId()));

            udb.desativarUsuario(u);
            carregaTabela();
            limparCampos();

            JOptionPane.showMessageDialog(rootPane, "Usuario " + usuario + " desativado com sucesso !");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuariosAtivos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UsuariosAtivos().setVisible(true);
            }
        });
    }
