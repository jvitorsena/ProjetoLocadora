 ...
 * @author jvito
 */
public class AluguelListarTodos extends javax.swing.JFrame {

    /**
     * Creates new form Clientes
     */
    public AluguelListarTodos() {
        initComponents();
        carregaTabela();
    }
    ...
    private void carregaTabela(){
        ...
        ArrayList<Aluguel> alugueis = alugueldb.listarAlugueis();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Todos alugueis"));
        ...
        tbAlugueis.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod", "Aluguel", "Valor", "Devolução", "Nome", "CPF", "Telefone", "Modelo", "Placa", "Ano", "Ativo"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.Float.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Boolean.class
            };
        ...
        if (tbAlugueis.getColumnModel().getColumnCount() > 0) {
            ...
            tbAlugueis.getColumnModel().getColumn(10).setMinWidth(50);
            tbAlugueis.getColumnModel().getColumn(10).setMaxWidth(50);
        }
    ...
    private void tbAlugueisMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbAlugueisMouseClicked
        ...
        a = adb.listarAlugueis().get(index);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AluguelListarTodos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AluguelListarTodos().setVisible(true);
            }
        });
    }
