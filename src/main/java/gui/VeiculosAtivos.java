 ...
 * @author jvito
 */
public class VeiculosAtivos extends javax.swing.JFrame {

    /**
     * Creates new form Clientes
     */
    public VeiculosAtivos() {
        initComponents();
        carregaTabela();
    }
...
//        ArrayList<Veiculo> veiculos = veiculodb.readAll();
        ArrayList<Veiculo> veiculos = veiculodb.listarVeiculosAtivos();
...
//                    v.getAno()
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Veiculos ativos"));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        v = vdb.listarVeiculosAtivos().get(index);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VeiculosAtivos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VeiculosAtivos().setVisible(true);
            }
        });
    }
